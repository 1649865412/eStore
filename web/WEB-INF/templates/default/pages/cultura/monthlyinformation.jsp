...
<html lang="en" class="no-js">
	...
	<body>
       ...
       <a class="grid__item w-g-h" href="/monthlyinformation/monthlytemplate.html?culId=${culList.culturalInformationId}&lastId=null&nextId=${culList[i.count+1].culturalInformationId}">
                </c:when>
              <c:when test="${i.count==fn:length(list)}">
       <a class="grid__item w-g-h" href="/monthlyinformation/monthlytemplate.html?culId=${culList.culturalInformationId}&lastId=${culList[i.count-1].culturalInformationId}&nextId=null">
                </c:when>
                <c:otherwise>
          <a class="grid__item w-g-h" href="/monthlyinformation/monthlytemplate.html?culId=${culList.culturalInformationId}&lastId=${culList[i.count-2].culturalInformationId}&nextId=${culList[i.count].culturalInformationId}">
                </c:otherwise>
            </c:choose>
