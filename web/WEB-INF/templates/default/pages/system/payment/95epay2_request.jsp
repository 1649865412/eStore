...
<%
    ...
    String pageUrl="https://www.eluxuryoutlets.com/system/payment/95epay2_response_ssl.html";
...
<body>
<iframe  width="100%" scrolling="auto" frameborder="0" height="890" name="paymentFrame" id="paymentFrame" src="${ctxPath}/system/payment/95epay2_loading_ssl.html">
</iframe>
<form id="paymentGatewayForm" name="paymentGatewayForm" target="paymentFrame" 
	action="https://www.95epay.com/payRequestAction.action" method="post">
	<input type="hidden" name="webSiteTemplate" value="innerPage">
