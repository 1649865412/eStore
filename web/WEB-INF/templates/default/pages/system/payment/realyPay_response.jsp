...
PaymentMethod paymentMethod=paymentMethodManager.getByPaymentMethodCode("realyPay");
    ...
    if (BillNo != null && Amount != null && Succeed != null & MD5key != null)
    {
    	...
    	String md5str = com.cartmatic.estore.system.util.TranslateService.md5Translate(md5src).toUpperCase();
