...
<html>
  ...
  <%
	...
	String M_URL=request.getScheme()+"://"+request.getHeader("host")+request.getContextPath()+"/system/payment/nps_response.html";
	String M_Language=(paramMap.get("M_Language")==null)? "1":paramMap.get("M_Language").toString();
	String MOCurrency=(paramMap.get("MOCurrency")==null)? "1":paramMap.get("MOCurrency").toString();
  ...
  <body onload="document.paymentGatewayForm.submit();">
	 <form name="paymentGatewayForm" method="post" action="https://payment.nps.cn/ReceiveMerchantAction.do">
