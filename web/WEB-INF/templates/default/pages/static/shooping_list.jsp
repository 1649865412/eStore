...
<body>
            ...
            <div class="container" style="position: relative;z-index: 1300;">
                ...
                <div class="row visible-md-block visible-lg-block">
                    <div class="col-md-2 col-lg-2 w-logo">
                        <a href="index.html" id="w-logot" class="logo_b change_logo"></a>
            ...
            <div class="product_box">
                <ul class="product list-unstyled col4 c sku_list" id="pinterestList">
                    <li>
                        <div class="li1">
                            <a href="#">
                                <img class="imgo" src="img/authors/10.jpg" />
                                <img class="imgt" src="img/authors/13.jpg" />
                            </a>
                        </div>
                        <div class="li2">
                            <div class="cutstr2">
                    ...
                    <li>
                        <div class="li1">
                            <a href="#">
                                <img class="imgo" src="img/authors/10.jpg" width="100%" />
                                <img class="imgt" src="img/authors/13.jpg" width="100%" />
                            </a>
                        </div>
                        <div class="li2">
                            <div class="cutstr2">
    ...
    <script src="${ctxPath}/scripts/jquery/js/jquery-1.11.3.min.js"></script>
