...
<c:choose>
	...
	<c:when test="${viewType==4}">
		...
		<c:choose>
			<c:when test="${productSku.priceViewType==2}">
				<b class="s1"><system:CurrencyForRate value="${productSku.salePrice}" /></b>
				<b class="s2"><system:CurrencyForRate value="${productSku.price}" /></b>
			</c:when>
			<c:when test="${productSku.priceViewType==3}">
				<b class="s1"><system:CurrencyForRate value="${productSku.discountPrice}" /></b>
				<b class="s2"><system:CurrencyForRate value="${productSku.price}" /></b>
			</c:when>
			<c:otherwise>
				<b class="s1">
