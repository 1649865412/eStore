function pagec() {
    ...
    //设置手机导航高度
    if ($(".w-menush-items.list-unstyled").height() > $(window).height())
        $(".w-menush-items.list-unstyled").height($(window).height() - 100);
    //初始化幻灯片高度
...
$(function () {
    ...
    $(".w-menusm .fa").click(function () {
        if (isopen) {
            ...
            isopen = false;
            $('.w-shooping-list-sort').css("z-index", "1031");
        } else {
            $(this).removeClass('fa-bars');
            $(this).addClass('fa-times');
            $(".w-menush").addClass('w-menush-s');
            isopen = true;
            $('.w-shooping-list-sort').css("z-index", "0");
        }
