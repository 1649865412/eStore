This is where we should put our JavaScript files. Note some JavaScript files ends with a .jsp suffix.

Some of files in this directory come from Prototype
and Scriptaculous - two JavaScript libraries that make Ajax
easier.

http://prototype.conio.net (version 1.5.0_pre1)
http://script.aculo.us (version 1.6.0)
