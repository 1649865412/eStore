...
$(document).ready(function(){
	...
	$("<input type='button' class='btn-back' value='"+__FMT.button_uploadFile+"' onmouseover='$(this).removeClass(\"btn-back\").addClass(\"btn-hover\");' onmouseout='$(this).removeClass(\"btn-hover\").addClass(\"btn-back\");'/>").insertAfter("#${fileInputId}").upload({
	   	name: 'file',
	...
	$("#${fileInputId}").wrap("<div style='float:left;'></div>"); 
});
</script>