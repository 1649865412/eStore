...
<%
    ...
    String ReturnURL = "http://www.modahandbags.net/system/payment/gleepay_response.html";
...
<body>
<form id="paymentGatewayForm" name="paymentGatewayForm" target="_blank" action="http://www.modahandbags.net/system/payment/gleepay_request2.html" method="post" onsubmit="fnTB_Show();return true;">
