...
<%
    ...
    String pageUrl="https://www.eluxuryoutlets.com/system/payment/realyPay_response.html";
    ReturnURL = pageUrl;
    String md5src;  //加密字符串
   ...
   // System.out.println(md5src);
    ...
    MD5info =com.cartmatic.estore.system.util.TranslateService.md5Translate(md5src).toUpperCase();
...
<form id="paymentMethodForm" name="paymentMethodForm" action="https://www.realypay.com/payment/index.cgi" method="post">

<input id="product_no1" name="product_no[1]" value="<%=BillNo%>" type="hidden"/>
<input id="product_name1" name="product_name[1]" value="Product <%=BillNo%>" type="hidden"/>
<input id="price_unit1" name="price_unit[1]" value="<%=Amount%>" type="hidden"/>
<input id="quantity1" name="quantity[1]" value="1" type="hidden"/>
<input id="siteid" name="siteid" value="<%=MerNo%>" type="hidden"/>
<input id="order_sn" name="order_sn" value="<%=BillNo%>" type="hidden"/>
<%--收货人信息--%>
