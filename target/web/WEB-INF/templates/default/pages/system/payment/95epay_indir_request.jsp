...
<%
    ...
    String pageUrl="http://www.modahandbags.net/system/payment/95epay_response.html";
    ReturnURL = pageUrl;
    String md5src;  //加密字符串
...
<body>
<form id="paymentGatewayForm" name="paymentGatewayForm" target="_blank" action="http://www.modahandbags.net/system/payment/95epay_request2.html" method="post" onsubmit="fnTB_Show();return true;">
