...
public class GsonUtils {
	...
	public static String toJson(Object target) {
		return toJson(target, null, true, SINCE_VERSION_10,
				DEFAULT_DATE_PATTERN, true);
	}
	...
	public static <T> T fromJson(String json, TypeToken<T> token,
		...
		try {
			...
			ex.printStackTrace();
			System.out.println(json + " �޷�ת��Ϊ " + token.getRawType().getName()
					+ " ����!" + ex.getMessage());
			return null;
		}
	}
	...
	public static <T> T fromJson(String json, Class<T> clazz, String datePattern) {
		...
		try {
			...
			System.out.println(json + " �޷�ת��Ϊ " + clazz.getName() + " ����!"
					+ ex.getMessage());
			return null;
		}
	}
	...
	public static String toJson(Object target, Type targetType,
		...
		try {
			...
			System.out.println("Ŀ����� " + target.getClass().getName()
					+ " ת�� JSON �ַ�ʱ�������쳣��" + ex.getMessage());
